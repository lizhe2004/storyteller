...
export interface StoryCharacter { id: string; name: string; description?: string; voice?: { provider: string; model?: string | null; voice_id: string; name?: string | null; gender?: string | null; age?: string | null; category?: string | null; description?: string | null } | null }
